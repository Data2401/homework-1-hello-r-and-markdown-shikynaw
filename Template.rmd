...
dino_data <- datasaurus_dozen %>% 
  filter(dataset == "dino") #piping datasaurus_dozen into the filter function to filter for observations
ggplot(data = dino_data, mapping = aes(x = x, y = y)) + #visualizing
  geom_point()
```
